...
function createDestroy(e, t, a = "router:will-change-url") {
    ...
    document.addEventListener("DOMContentLoaded", i), window.addEventListener("router:did-update-content", i), window.addEventListener(a, (function () {
        o && (o(), o = void 0)
    }))
}
...
function loadStyles(e) {
    ...
    return new Promise((a => {
        if (document.querySelector(`link[href="${e}"]`)) return void a(t);
        const o = document.createElement("link");
        o.onload = function () {
            a(t)
        }, o.rel = "stylesheet", o.href = e, document.querySelector("head").appendChild(o)
    }))
}(() => {
    const e = [],
        t = {};
    window.experimentValueFor = function (e, a) {
        ...
        try {
            ...
            localStorage.setItem(a, o), t[e.name] = e.variants.find((({
                name: e
            }) => e === o))
        } catch (e) {
            return
        }
        "undefined" != typeof gtag && (gtag("event", `${key}_${variantName}`), gtag("event", "experiment", {
            name: key,
            variant: variantName
        }))
    }))
    ...
    return function (t) {
        return new Promise((a => {
            if (e[t]) return void a();
            e[t] = !0;
            const o = new Image;
            o.onload = function () {
                a()
            }, o.onerror = function () {
                delete e[t], console.error(new Error(`Failed to preload image at "${t}"`))
            }, o.src = t
        }))
    }
})(), (() => {
    ...
    e && (e.onload = () => {
        ...
        Sentry.init(e), window.console.error = function (e) {
    ...
    return t.querySelector("input[type=email]").addEventListener("focus", (function () {
            ...
            o.blur(), await async function (e) {
                t.classList.add("footer-contact-subscription-loading"), "undefined" != typeof gtag && gtag("event", "footer_subscribe");
                try {
            ...
            }(o.value), t.querySelector("input[type=email]").value = "", e.querySelector("form").reset()
        })),
        function () {}
})), createDestroy(/.*/, (function () {
    return document.body.querySelectorAll(".infinite-slideshow").forEach((e => {
            void 0 === e.dataset.init && function (e) {
                e.dataset.init = !0;
                let t, a, o = e.querySelector(".infinite-slideshow-spacer"),
                ...
                function p() {
                    f(), u(Math.floor(o.clientWidth / r / 2 / n.length) * n.length + c % n.length), e.removeEventListener("scroll", y), h(!1);
                    const t = .5 * (e.clientWidth - r);
                    e.scrollLeft = c * r - (e.clientWidth - r) + t, f(), h(!0), e.addEventListener("scroll", y)
                }
                ...
                m(), p(), e.addEventListener("jump", (function (a) {
                    e.scrollTo({
                        left: (c + a.detail.direction) * r - .5 * (e.clientWidth - r),
                        behavior: "smooth"
                    }), clearTimeout(t), t = setTimeout(p, 600)
                })), window.addEventListener("resize", (function () {
                    h(!1), clearTimeout(t), clearTimeout(a), a = setTimeout((() => {
                        i = !1, h(!0)
                    }), 100), i = !0, r = n[0].clientWidth, s = n[0].clientHeight, e.scrollLeft = c * r - .5 * (e.clientWidth - r), f(), m()
                }))
            }(e)
        })),
        function () {}
    ...
    return document.body.querySelectorAll(".modern-slideshow").forEach((e => {
            void 0 === e.dataset.init && function (e) {
                ...
                e.dataset.init = !0, setTimeout((() => {
                    e.scrollTo(0, 0)
                }), 40), e.addEventListener("click", (function (a) {
    ...
    function a(a) {
        ...
        })), e.classList.toggle("transition-configurator", o.startsWith("/backyard/configure")), setTimeout((() => {
            e.classList.add("collapsed")
        }), 400)
    }
    e.querySelector(".backyard-configure").hidden = !1, window.addEventListener("router:will-change-url", a);
    ...
    o && o.addEventListener("click", (function () {
        ...
        e.addEventListener("mouseenter", n), e.addEventListener("mouseleave", i)
    })), a({
        detail: {
    ...
    function l(e = null) {
        ...
        return t = t.split("#")[0], t.length > 1 && t.endsWith("/") && (t = t.slice(0, t.length - 1)), "/" === t ? "/backyard" : t.startsWith("/backyard/configure") ? "/backyard/configure" : t.startsWith("/backyard/pay") ? "/backyard/pay" : t
    }

    function u() {
        let t = e[l()];
        void 0 !== t && (null !== o && o.setAttribute("content", t.theme_color), document.body.classList.add(...t.class_names.split(" ")), null !== n && n.classList.toggle("inverted", t.navigation_inverted)), r = l()
    }
    async function m(o, h = !0, p = !0) {
        if (c) return void(s = [o, h]);
        if (h && (o === location.pathname || "/" === o && "/backyard" === location.pathname || "/backyard" === o && "/" === location.pathname)) return void window.scrollTo({
            top: 0,
            behavior: "smooth"
        });
        c = !0, i.classList.add("segue");
        const f = function (t) {
        ...
        if (g && "pending" !== g) y = g;
            ...
            y = await e.text(), t[w] = y
        } catch (e) {
            console.error("failed to load page", o)
        }! function () {
            const t = e[r || l()];
            void 0 !== t && null !== n && (document.body.classList.remove(...t.class_names.split(" ")), n.classList.toggle("inverted", !t.navigation_inverted))
        }(), window.scrollTo({
            top: 0
        }), a.innerHTML = y, d("router:did-update-content", {
            url: o
        });
        const v = e[l(o)];
        document.title = v ? .title, h && window.history.pushState(null, v, o), u(), p && await
        function (e) {
            return new Promise((t => {
                i.classList.remove(e < 0 ? "out-pop" : "out"), i.addEventListener("animationend", (() => {
                    i.classList.remove(e < 0 ? "in-pop" : "in"), t()
                }), {
                    once: !0
                }), i.classList.add(e < 0 ? "in-pop" : "in")
            }))
        }(f), d("router:did-change-url", {
            url: o
        }), c = !1, setTimeout((() => {
            i.classList.remove("segue")
        }), 10), s.length > 0 && (setTimeout(m, 0, ...s), s = [])
    }
    ...
    window.openRoute = m, window.addEventListener("click", (function (e) {
        if (e.metaKey) return;
        const t = h(e.target);
    ...
    window.Tooltip = function () {
        ...
        function u() {
            document.querySelectorAll("*[data-tooltip]").forEach((e => {
                e.removeAttribute("data-tooltip"), e.addEventListener("mousemove", (function (t) {
                    ...
                    a && 0 === e.scrollLeft ? f() : a || e.scrollLeft !== e.scrollWidth - e.clientWidth ? h(a ? "arrow-left" : "arrow-right", "", c.x, c.y) : f()
        ...
        function p(e, o) {
            clearTimeout(n), n = setTimeout(l, t), a.classList.remove("dismissed"), c = {
                x: e,
                y: o
        ...
        function y() {
            0 === s.x && (s = c), s.x = s.x + (c.x - s.x) * e, s.y = s.y + (c.y - s.y) * e, a.style.transform = `translate3d(${s.x.toFixed(2)}px,${s.y.toFixed(2)}px,0.0)`, d = Math.abs(s.x - c.x) > .1 || Math.abs(s.y - c.y) > .1, d && requestAnimationFrame(y)
        }
    ...
    function n() {
        ...
        t.classList.add("change"), setTimeout((() => {
            t.innerText = a.getAttribute("alt"), t.classList.remove("change")
        }), 200)
    }
    ...
    function r() {
        clearTimeout(o), o = setTimeout(i, 4e3)
    }
    ...
    return r(), e.addEventListener("change", (function () {
            t.classList.add("change"), clearTimeout(a), a = setTimeout(n, 200)
    ...
    return document.querySelectorAll(".bento-details-card").forEach((function (e) {
            e.addEventListener("click", (function (t) {
                ...
                if (a) {
                    o.style.transition = "none", o.style.maxHeight = "unset", o.style.opacity = 0;
                    const e = o.clientHeight;
                    o.style.transition = null, o.style.maxHeight = null, setTimeout((() => {
                        o.style.maxHeight = e + "px", o.style.opacity = 1
                    }), 0)
                } else o.style.maxHeight = null, o.style.opacity = null
            }))
        })),
        function () {}
    ...
    return document.querySelectorAll(".interior-carousel-cards-card").forEach(((e, t, a) => {
            e.addEventListener("click", (function (t) {
                ...
                if (!o && s > 0 && Math.abs(s) > .5 * i) t.stopPropagation(), e.parentElement.classList.add("scrolling"), e.parentElement.scrollTo({
                    left: e.parentElement.scrollLeft - e.clientWidth,
                    behavior: "smooth"
                });
                else if (!o && s < 0 && Math.abs(s) > .5 * i) t.stopPropagation(), e.parentElement.classList.add("scrolling"), e.parentElement.scrollTo({
                    left: e.parentElement.scrollLeft + e.clientWidth,
                    behavior: "smooth"
                });
                ...
                setTimeout((function () {
                    a.forEach((e => {
                        const {
                            left: t,
                            width: a
                        } = e.getBoundingClientRect(), o = Math.round(t + .5 * a), n = .5 * window.innerWidth - o;
                        e.parentElement.classList.remove("scrolling"), e.classList.toggle("current", Math.abs(n) < .5 * a)
                    }))
                }), 600)
            }))
        })),
    ...
    function i(a) {
        ...
        r && (r.innerText = t[n]), o.forEach(((e, t) => {
    ...
    return a.addEventListener("change", (function (e) {
        ...
        function () {
            document.removeEventListener("scroll", r), window.removeEventListener("resize", r)
        }
    ...
    return window.addEventListener("scroll", a, {
            ...
            for (let e = 0; e < a.length; e++) a[e].forEach((e => {
    ...
    function a() {
        ...
        if (o)
            ...
            } else e.classList.toggle("inverted", void 0 !== o.dataset.invert)
    }
    return window.addEventListener("scroll", a, {
            passive: !0
        }), a(),
    ...
    function n(n) {
        if (clearTimeout(a), a = setTimeout(o, 1e4), e.classList.add("active"), "INPUT" === n.target.nodeName) return;
        let i = t.findIndex((e => !0 === e.checked));
        i < t.length - 1 ? i += 1 : i = 0, t.forEach(((e, t) => e.checked = t === i))
    }
    ...
    const e = new IntersectionObserver((t => {
        t.forEach((({
            ...
            t && (a.setAttribute("loading", "eager"), "VIDEO" === a.nodeName && a.clientWidth > 0 && a.play(), e.unobserve(a))
        }))
    }), {
        rootMargin: "100%"
    });
    ...
    async function o(o) {
        ...
        if (o.target.disabled = !0, n.classList.add("loading"), a = await window.Payment.tokenizeCard(t), a) {
            200 === (await window.API.paymentRequestFulfill(e, a)).status && n.classList.add("successful")
        }
        n.classList.remove("loading"), o.target.disabled = !1
    }
    createDestroy(/^\/backyard\/pay/, (async () => {
        if (!e) return;
        document.querySelector("nav").classList.remove("inverted"), document.body.classList.add("pay"), await new Promise(((e, t) => {
            if ("undefined" != typeof Square) return void e();
            const a = document.createElement("script");
            a.src = window.Payment.SCRIPT_URL, a.onload = e, a.onerror = t, document.querySelector("head").appendChild(a);
            const o = document.createElement("script");
            document.querySelector("head").appendChild(o)
        }));
        const a = document.querySelector("#payment-container"),
            n = await window.Payment.createPaymentForm(a);
        return payments = n.payments, t = n.card, document.querySelector(".payment .details button").addEventListener("click", o), () => {
            t && t.destroy(), document.body.classList.remove("pay")
        }
    }))
    ...
    let s, c = 1,
        d = Array(n.length).fill(0);

    function l(e, t) {
        c = Math.max(Math.min(e, n.length - 1), 0), a.scrollTo({
    ...
    function m(l) {
        l ? (clearTimeout(s), a.classList.add("without-animation"), s = setTimeout((() => {
        ...
        n.forEach(((e, a) => {
            e.classList.toggle("selected", a === c), e.querySelectorAll("img").forEach(((e, t) => {
                e.classList.toggle("current", t === d[a])
            }));
            const [o, n, i, r] = t[p][a], s = (u = i) + (h - (l = o)) / (n - l) * (r - u);
            var l, u;
    ...
    return o.forEach(((e, t) => {
            ...
            r[0].classList.toggle("highlight", e.clientX < .5 * a.clientWidth), r[1].classList.toggle("highlight", e.clientX > .5 * a.clientWidth), e.clientX < .5 * a.clientWidth ? a.style.cursor = 0 === c ? null : "pointer" : e.clientX > .5 * a.clientWidth && (a.style.cursor = c === n.length - 1 ? null : "pointer")
            ...
            passive: !0
        }), l(1, !0), document.querySelector(".three-sizes-footer-calculator").addEventListener("click", (function () {
            Calculator.show("both", void 0, void 0, c)
        })),
        function () {
            window.removeEventListener("scroll", h), window.removeEventListener("resize", h)
        }
}, "complete" === document.readyState && document.body.classList.add("complete"), window.addEventListener("load", (() => {
...
}), "router:did-update-content"), createDestroy(/^\/showrooms\/events.*/, (function () {
        ...
        return t = [], Array(n).fill(null).forEach((() => {
                setTimeout((() => {
                    const e = function () {
                        ...
                        return d.className = "dot", d.style.width = "14px", d.style.height = "14px", d.style.opacity = t ? .3 : null, {
                            x: a,
                            y: o,
                            vx: s,
                            vy: c,
    ...
    function e(e) {
        e.parentElement.classList.add("newsroom-internal-feedback-visible"), setTimeout((() => {
    ...
    globalThis.Newsroom = {
        ...
        downloadImages(e) {
            e.preventDefault(), document.querySelectorAll(".newsroom img[data-downloadable]").forEach((e => {
                const t = document.createElement("a");
                t.href = e.src, t.target = "_blank", t.download = e.src.split("/").reverse()[0], t.click()
            }))
        },
        copyLink(t) {
    ...
    document.querySelectorAll(".showroom-events").forEach((a => {
        ...
        a.dataset.numberOfEvents = o.filter((t => Date.parse(t.start_at) > e)).length, a.querySelectorAll("li").forEach(((t, a) => {
